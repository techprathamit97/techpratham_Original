                        ...
                        <form className='w-full flex flex-col gap-4 p-5 rounded-2xl bg-white h-full' onSubmit={handleEasebuzzSubmit(onEasebuzzSubmit)}>
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                                ...
                                <div className='w-full'>
                                    ...
                                    <Input {...registerEasebuzz('amount', {
                                        required: true,
                                        validate: (v) => {
                                            const n = parseFloat(String(v).replace(/,/g, ''));
                                            return (!isNaN(n) && n > 0) || 'Enter a valid amount';
                                        }
                                    })} type='text' inputMode='numeric' id='easebuzz-amount' name='amount' className='w-full p-3 border-2 border-gray-200 rounded-lg focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all duration-200' placeholder='e.g. 5000' required />
                                </div>
                            </div>
