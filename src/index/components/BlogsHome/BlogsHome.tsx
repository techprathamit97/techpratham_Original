...
//         ) : posts?.length > 0 ? (
//           posts.map((post) => (
//             <Link key={post._id} href={`/blog/${post.slug}`} className="w-[300px] h-[140px]">
//               <div
...
const BlogsHome = () => {
  ...
  return (
    <div className='w-full h-auto flex flex-col items-center justify-center pt-10 pb-10 gap-10 bg-black text-white'>
