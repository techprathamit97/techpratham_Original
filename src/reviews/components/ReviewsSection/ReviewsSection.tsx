...
const ReviewsSection = () => {
    ...
    return (
        <div className='w-full h-auto flex flex-col items-center justify-center py-20 gap-10 bg-[#f7f7f7] text-black overflow-hidden'>
            ...
            <div className='md:w-10/12 w-11/12 flex flex-col gap-6 items-center justify-center h-auto'>
                {testimonialsData.map((testimonial) => (
                    <div key={testimonial.id} className="group w-auto h-auto flex flex-col gap-4 bg-white rounded-2xl p-6 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/20 hover:-translate-y-2 hover:scale-105 border border-gray-100 relative overflow-hidden cursor-pointer">
