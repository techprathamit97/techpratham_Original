const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: '/courses/servicenow-it-service-management-itsm-training',
        destination: '/courses/servicenow-itsm-training',
        permanent: true,
      },
      {
      ...
      {
        source: '/courses/sap-online-training-in-delhi',
        destination: '/courses/sap-training-in-delhi',
        permanent: true,
      },
      {
        source: '/courses/sap-online-training-in-mumbai',
        destination: '/courses/sap-training-in-mumbai',
        permanent: true,
      },
      {
