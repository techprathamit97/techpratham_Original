...
const Login = () => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        // Admin/accountant accounts are required to use the secure OTP portal.
        // If authorize() blocks them here, send them to /auth/super-user.
        if (res?.error && /OTP verification required/i.test(res.error)) {
            setLoading(false);
            router.push("/auth/super-user");
            return;
        }
