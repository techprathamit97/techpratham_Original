...
const CreateManualInvoice = () => {
  ...
  const fetchInvoiceForEdit = async (invoiceId: string) => {
    try {
      ...
      setTimeout(() => {
        router.push('/accountant/dashboard/invoices');
      }, 2000);
    }
  };
  ...
  return (
    <React.Fragment>
      <Head>
        <title>{isEditing ? 'Edit Manual Invoice' : 'Create Manual Invoice'} | Accountant Dashboard</title>
      </Head>
              ...
              <div className="p-6">
                <div className='w-full h-auto flex flex-row items-start justify-between mb-8'>
                  <div className="flex items-center gap-4">
                    <Link href="/accountant/dashboard/invoices">
