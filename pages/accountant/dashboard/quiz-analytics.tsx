...
const QuizAnalytics = () => {
  const { loading, authenticated, isAccountant, setCurrentTab } = useContext(UserContext);
  ...
  if (!authenticated || !isAccountant) return <SignOut />;

  return (
    <>
      <Head>
        <title>Quiz Analytics | Accountant Dashboard</title>
