...
const CategoryPage = () => {
    const { loading, authenticated, userData, isAccountant, currentTab, setCurrentTab } = useContext(UserContext);
    ...
    return (
        <React.Fragment>
            <Head>
                ...
                <title>Manage Category | Accountant Dashboard</title>
                <meta name="description" content="Explore the Manage Category section in Accountant Dashboard of TechPratham." />
            </Head>
